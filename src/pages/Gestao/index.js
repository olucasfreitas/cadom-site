  ...
  return (
    ...
    <div id="container-gestao" className="Gestao">
      ...
      <div id="header-container">
        <div id="navBar-gestao">
          <BsJustify id="icon-tabbar"/>
        </div>
      </div> 
      ...
      <div id="body-gestao">
          <h1 id="title-page-gestao"> Gestão </h1>
            ...
            <div id="textContainer-gestao">
              <h1 id="textContainer-title">Atas</h1>
            ...
            <div id="textContainer-gestao">
              <h1 id="textContainer-title">Estatuto</h1>
                <p id="textContainer-text">
                  &nbsp;
            ...
            <div id="textContainer-gestao">
              <h1 id="textContainer-title">Editais</h1>
                <p id="textContainer-text">
                  &nbsp;
                  &nbsp;
